...
public class PriceResourceIT {
    ...
    private static final Season DEFAULT_STATUS_PERIOD = Season.HIGH;
    private static final Season UPDATED_STATUS_PERIOD = Season.MEDIUM;
    ...
    public static Price createEntity(EntityManager em) {
        Price price = new Price()
            .price(DEFAULT_PRICE)
            .statusPeriod(DEFAULT_STATUS_PERIOD);
        return price;
    }
    /**
    ...
    public static Price createUpdatedEntity(EntityManager em) {
        Price price = new Price()
            .price(UPDATED_PRICE)
            .statusPeriod(UPDATED_STATUS_PERIOD);
        return price;
    }
    ...
    public void createPrice() throws Exception {
        ...
        assertThat(testPrice.getStatusPeriod()).isEqualTo(DEFAULT_STATUS_PERIOD);
    }
    ...
    public void getAllPrices() throws Exception {
        ...
        restPriceMockMvc.perform(get("/api/prices?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].statusPeriod").value(hasItem(DEFAULT_STATUS_PERIOD.toString())));
    }
    ...
    public void getPrice() throws Exception {
        ...
        restPriceMockMvc.perform(get("/api/prices/{id}", price.getId()))
            ...
            .andExpect(jsonPath("$.statusPeriod").value(DEFAULT_STATUS_PERIOD.toString()));
    }
    ...
    public void updatePrice() throws Exception {
        ...
        assertThat(testPrice.getStatusPeriod()).isEqualTo(UPDATED_STATUS_PERIOD);
    }
